...
import com.c314.radiantprojects.utils.padWithDisplayCutout
import com.c314.radiantprojects.utils.showImmersive
import java.io.File
import java.util.*
...
class GalleryFragment internal constructor() : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (mediaList.isEmpty()) {
            ...
            view.findViewById<ImageButton>(R.id.upload_button).isEnabled = false
        }
        ...
        view.findViewById<ImageButton>(R.id.upload_button).setOnClickListener {
            ...
            mediaList.getOrNull(mediaViewPager.currentItem)?.let { mediaFile ->
                ...
                // when success navigate to result fragment
                Navigation.findNavController(
                    requireActivity(), R.id.fragment_container
                ).navigate(
                    GalleryFragmentDirections.actionGalleryFragmentToResultFragment()
                )
